...
export const metadata: Metadata = {
  title: 'About PatentPending',
  description: 'PatentPending guides you through the entire patent process — from first idea to USPTO filing — with AI-powered help every step of the way.',
}
    ...
    <div className="min-h-screen bg-white">
      ...
      <footer className="border-t border-gray-100 py-6">
        <div className="max-w-6xl mx-auto px-6 text-center text-sm text-gray-400">
          © {new Date().getFullYear()} PatentPending ·{' '}
          <a href="mailto:support@patentpending.app" className="hover:underline">support@patentpending.app</a>
        </div>
      </footer>
    </div>
  )
