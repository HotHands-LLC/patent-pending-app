    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold text-[#1a1f36]">Patents</h1>
            <p className="text-gray-500 mt-1">{patents.length} patent{patents.length !== 1 ? 's' : ''} in portfolio</p>
          </div>
          <Link href="/dashboard/patents/new" className="px-4 py-2 bg-[#1a1f36] text-white rounded-lg text-sm font-semibold hover:bg-[#2d3561] transition-colors">
            + Register Patent
          </Link>
        </div>
        ...
        {patents.length === 0 ? (
          <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
            ...
            <Link href="/dashboard/patents/new" className="px-4 py-2 bg-[#1a1f36] text-white rounded-lg text-sm font-semibold">
              Register Patent
            </Link>
          </div>
        ) : (
